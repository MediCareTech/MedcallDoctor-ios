...
#import "PersonalHealthDataVc.h"
#import "smartRxDashboardVC.h"
#import "SmartRxPHRDetailsVC.h"

@interface PersonalHealthDataVc ()

@end

@implementation PersonalHealthDataVc
...
- (void)viewDidLoad {
    [super viewDidLoad];
    [[SmartRxCommonClass sharedManager] setNavigationTitle:@"Personal Health Data" controler:self];
