                            ...
                            text:(NSString *)text
{
    ...
    self = [self initWithSenderId:senderId senderDisplayName:senderDisplayName mediaPath:@"" date:date isMedia:NO];
    if (self) {
        _text = [text copy];
    }
    return self;
                           ...
                           media:(id<JSQMessageMediaData>)media
{
    ...
    self = [self initWithSenderId:senderId senderDisplayName:senderDisplayName mediaPath:mediaPath date:date isMedia:YES];
    if (self) {
        _media = media;
    }
    return self;
                         ...
                         isMedia:(BOOL)isMedia
{
    ...
    NSParameterAssert(mediaPath != nil);
