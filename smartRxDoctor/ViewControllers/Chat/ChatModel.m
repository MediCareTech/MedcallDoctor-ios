...
//
//
//        JSQMessagesAvatarImage *jsqImage = [avatarFactory avatarImageWithUserInitials:@"BlankUser.jpg"
...
//
//
//        JSQMessagesAvatarImage *cookImage = [avatarFactory avatarImageWithImage:[UIImage imageNamed:@"BlankUser.jpg"]];
//
//        JSQMessagesAvatarImage *jobsImage = [avatarFactory avatarImageWithImage:[UIImage imageNamed:@"BlankUser.jpg"]];
//
//        JSQMessagesAvatarImage *wozImage = [avatarFactory avatarImageWithImage:[UIImage imageNamed:@"BlankUser.jpg"]];
...
-(NSDictionary *)addingAvathars:(NSArray *)avatharArr{
    NSMutableDictionary *avatharDict = [[NSMutableDictionary alloc]init];
    for (NSDictionary *dict in avatharArr) {
    NSString *escapedString = [dict[@"avtharUrl"] stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]];

    UIImage *image = [UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:escapedString]]];
    
    JSQMessagesAvatarImageFactory *avatarFactory = [[JSQMessagesAvatarImageFactory alloc] initWithDiameter:kJSQMessagesCollectionViewAvatarSizeDefault];
     JSQMessagesAvatarImage *avathar = [avatarFactory avatarImageWithImage:image];
        [avatharDict setObject:avathar forKey:dict[@"senderId"]];
        
    }
   // self.avatars = [avatharDict mutableCopy];
//    self.avatars = @{ kJSQDemoAvatarIdSquires : jsqImage,
//                      kJSQDemoAvatarIdCook : cookImage,
//                      kJSQDemoAvatarIdJobs : jobsImage,
//                      kJSQDemoAvatarIdWoz : wozImage };
    
    return [avatharDict mutableCopy];
