...
@interface SmartRxQuestionDetailsVC (){
    MBProgressHUD *HUD;
    CGFloat heightLbl;
...
-(void)makeRequestForViewQuestions
{
    ...
    NSString *url=[NSString stringWithFormat:@"%@%@",WB_BASEURL,@"dviewqa"];
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    {
        ((SmartRxPostDetaisVC *)segue.destinationViewController).dictMsgDetails = [[NSMutableDictionary alloc] init];
        ((SmartRxPostDetaisVC *)segue.destinationViewController).dictMsgDetails = [self.dictQuestionDetails mutableCopy];
    }
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0)
    {
        ...
        estHeight = estHeight+heightLbl+100;
...
//                footerView.clipsToBounds = YES;
        ...
        tableView.contentSize = CGSizeMake(tableView.contentSize.width, tableView.contentSize.height+100);
//        return nil;
        return footerView;
    }else{
        if(footerView == nil) {
