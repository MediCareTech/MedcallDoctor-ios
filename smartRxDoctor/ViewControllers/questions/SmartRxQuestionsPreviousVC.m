...
-(void)makeRequestForNewQuestions
{
    ...
    NSString *bodyText;
    NSString *url;
    if ([[[NSUserDefaults standardUserDefaults] objectForKey:@"fromPatLookUp"] boolValue])
    {
        bodyText = [NSString stringWithFormat:@"%@=%@&patid=%@",@"sessionid",sectionId, self.patientID];
        url =[NSString stringWithFormat:@"%@%@",WB_BASEURL,@"dpatbyid"];
    }
    else
    {
        bodyText = [NSString stringWithFormat:@"%@=%@",@"sessionid",sectionId];
        url =[NSString stringWithFormat:@"%@%@",WB_BASEURL,@"dqa"];
    }
...
{
    NSDictionary *dictTemp=[NSDictionary dictionaryWithObjectsAndKeys:[[self.arrQuestions objectAtIndex:indexPath.row]objectForKey:@"qtitle"],@"title", [[self.arrQuestions objectAtIndex:indexPath.row]objectForKey:@"patname"], @"patname",[[self.arrQuestions objectAtIndex:indexPath.row]objectForKey:@"qdesc"],@"des",[[self.arrQuestions objectAtIndex:indexPath.row]objectForKey:@"modified"],@"time",[[self.arrQuestions objectAtIndex:indexPath.row]objectForKey:@"qid"],@"qid",[[self.arrQuestions objectAtIndex:indexPath.row]objectForKey:@"iscompleted"],@"Answred", [[self.arrQuestions objectAtIndex:indexPath.row]objectForKey:@"qid"],@"qid",[[self.arrQuestions objectAtIndex:indexPath.row]objectForKey:@"askrfeed"],@"askrfeed",nil];
