...
-(void)makeRequestToGetPhrDetails
{
    ...
    NSString *url=[NSString stringWithFormat:@"%@%@",WB_BASEURL,@"dgetphr"];
    [[SmartRxCommonClass sharedManager] postOrGetData:url postPar:bodyText method:@"POST" setHeader:NO  successHandler:^(id response) {
        
        NSLog(@"phr response:%@",response);
...
//        }
    ...
    else
    {
        ...
        {
            errorLabel.text = [NSString stringWithFormat:@"\u2022 No Health Records found.",self.navigationItem.title];
        }
